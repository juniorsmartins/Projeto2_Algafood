...
import io.algafoodapi.camada1_presentation.mapper.RestauranteMapper;
import io.algafoodapi.camada2_business.core.Constantes;
import io.algafoodapi.camada2_business.core.validation.ValidacaoException;
import io.algafoodapi.camada2_business.exception.http400.RequisicaoMalFormuladaException;
import io.algafoodapi.camada2_business.exception.http404.RestauranteNaoEncontradoException;
import io.algafoodapi.camada2_business.exception.http409.RestauranteEmUsoException;
import io.algafoodapi.camada2_business.model.Restaurante;
import io.algafoodapi.camada3_infraestrutura.repository.jpa.CidadeRepositoryJpa;
